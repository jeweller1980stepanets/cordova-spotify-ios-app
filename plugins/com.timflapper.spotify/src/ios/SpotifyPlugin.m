...
- (void)authenticate:(CDVInvokedUrlCommand*)command
{
    ...
    [self.commandDelegate runInBackground:^{
        ...
        NSURL *url = auth.spotifyWebAuthenticationURL;
        NSLog(@"Login url - %@",url);
...
- (void)renewSession:(CDVInvokedUrlCommand *)command
{
    ...
    [self.commandDelegate runInBackground:^{
        [[SPTAuth defaultInstance]
         ...
         callback:^(NSError *error, SPTSession *newSession) {
             CDVPluginResult *pluginResult;
...
/*
 ...
 [self.commandDelegate runInBackground:^{
 SpotifyAudioPlayer *player;// = [SPTAudioStreamingController sharedInstance];//initWithClientId:clientId];
 
 SPTAuth *auth = [SPTAuth defaultInstance];
 //  [player startWithClientId:<#(NSString *)#> error:<#(NSError *__autoreleasing *)#>
 [player startWithClientId:clientId callback:^(NSError *error) {
 CDVPluginResult *pluginResult;
